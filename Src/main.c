...
#define gRatio 1
#endif
#define S16A_TO_FLOAT 0.000030517578125
/* USER CODE END PTD */
...
/* USER CODE BEGIN PV */
const int INIT_ID = 		MOTOR0_INIT_ID;
const int DRIVE_ID = 		MOTOR0_DRIVE_ID;
const int ENC_POS_ID =		ENC0_POS_ID;
const int REF_TENSION_ID = 	MOTOR0_TENSION_ID;
const int RES_POS_ID = 		MOTOR0_RES_POS_ID;
const int RES_CURRENT_ID = 	MOTOR0_RES_CURRENT_ID;
const int RES_TENSION_ID = 	MOTOR0_RES_TENSION_ID;
const int REQ_ID = 			MOTOR0_REQUEST_ID;

bool motor_ready = false;
bool heartbeat = false;
const float plim =  0;
const float nlim = -2*PI;
const float spring_constant = 0.02;	// [N/mm]
const float drum_diameter = 25;		// [mm]
enum ERROR_STATE {
	nominal, CAN_lost, out_of_range, fault_yet, enc_alig_fault, other
} errorID = nominal;
uint8_t requested_response_type = 0;	// 1st_bit:tension, 2nd_bit:current, 3rd_bit:motor_position
float refTension = 0;
...
/* USER CODE BEGIN PFP */
void Send_CAN(uint16_t, uint8_t*);
...
void Response(){
	if (requested_response_type & 0b00000001) {
		...
		Send_CAN( RES_TENSION_ID,  send_data);
