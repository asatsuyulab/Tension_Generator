...
#define MAX_APPLICATION_SPEED_RPM       6342 /*!< rpm, mechanical */
...
#define PID_TORQUE_KP_DEFAULT         2834
#define PID_TORQUE_KI_DEFAULT         1643
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           2834
...
#define PID_SPEED_KP_DEFAULT          3870/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          9/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_CONTROL_MODE           STC_SPEED_MODE /*!< STC_TORQUE_MODE or
                                                        STC_SPEED_MODE */
#define DEFAULT_TARGET_SPEED_RPM      1334
...
#define FINAL_I_ALIGNMENT               1061 /*!< s16A */
